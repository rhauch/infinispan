...
public class Null {
   ...
   public static class Externalizer extends AbstractExternalizer<Null> {
      ...
      @Override
      public void writeObject(ObjectOutput output, Null value) throws IOException {
      }

      @Override
      public Null readObject(ObjectInput input) throws IOException, ClassNotFoundException {
