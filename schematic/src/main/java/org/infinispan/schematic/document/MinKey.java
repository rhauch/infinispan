...
public class MinKey {
   ...
   public static class Externalizer extends AbstractExternalizer<MinKey> {
      ...
      @Override
      public void writeObject(ObjectOutput output, MinKey value) throws IOException {
      }

      @Override
      public MinKey readObject(ObjectInput input) throws IOException, ClassNotFoundException {
