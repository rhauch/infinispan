...
public final class MaxKey {
   ...
   /**
    * The largest UTF-8 character that will fit into 2 bytes is U+07FF. Therefore, if we make a string that contains a
    * (non UTF-8) unicode character larger than this, that string should always be treated as larger than all UTF-8
    * strings.
    */
   ...
   public static class Externalizer extends AbstractExternalizer<MaxKey> {
      ...
      @Override
      public void writeObject(ObjectOutput output, MaxKey value) throws IOException {
      }

      @Override
      public MaxKey readObject(ObjectInput input) throws IOException, ClassNotFoundException {
