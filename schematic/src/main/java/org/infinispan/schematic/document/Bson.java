...
public class Bson {
   ...
   public static final class BinaryType {
      ...
      /**
       * The old generic subtype. This used to be the default subtype, but was deprecated in favor of {@link #GENERAL}.
       * Drivers and tools should be sure to handle this type appropriately.
       * 
    ...
    * @throws IOException
    *            if there was a problem writing to the ObjectOutput
    */
   ...
   public static int getTypeForValue(Object value) {
      ...
      if (value instanceof Pattern)
         return Type.REGEX;
      if (value instanceof Symbol)
         return Type.DBPOINTER;
      if (value instanceof Code)
         return Type.JAVASCRIPT;
      if (value instanceof CodeWithScope)
         return Type.JAVASCRIPT_WITH_SCOPE;
