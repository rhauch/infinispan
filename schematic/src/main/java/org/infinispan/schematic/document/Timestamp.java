...
/**
 * A {@link Bson.Type#TIMESTAMP timestamp} value for use within a {@link Document BSON object}. <b>Note that using
 * {@link Date} is recommended for most applications and use cases, as they are more generally suited for representing
 * instants in time.</b>
 * 
