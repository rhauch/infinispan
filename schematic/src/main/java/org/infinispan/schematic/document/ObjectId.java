...
/**
 * A {@link Bson.Type#OBJECTID ObjectId} value for use within a {@link Document BSON object}, and are 12-byte binary
 * values designed to have a reasonably high probability of being unique when allocated.
 * 
...
public final class ObjectId {
   ...
   public static class Externalizer extends AbstractExternalizer<ObjectId> {
      ...
      @Override
      public ObjectId readObject(ObjectInput input) throws IOException, ClassNotFoundException {
