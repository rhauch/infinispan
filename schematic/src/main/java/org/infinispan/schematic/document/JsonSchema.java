...
public class JsonSchema {
   ...
   public static enum Type {
      STRING("string"), NUMBER("number"), INTEGER("integer"), BOOLEAN("boolean"), OBJECT("object"), ARRAY("array"), NULL(
               "null"), ANY("any"), UNION("union"), UNKNOWN("unknown");
      ...
      static {
         ...
         equiv.put(Type.ANY, EnumSet.of(Type.STRING, Type.NUMBER, Type.INTEGER, Type.BOOLEAN, Type.OBJECT, Type.ARRAY,
                  Type.NULL, Type.ANY, Type.UNION, Type.UNKNOWN));
