...
public class DocumentEditor implements EditableDocument {
    ...
    * @return the edited document; never null
    */
   ...
   /**
    * The method that does the actual setting for all of the <code>set...</code> methods. This method may be overridden
    * by subclasses when additional work needs to be performed during the set operations.
    * 
    * @param name
   ...
   protected EditableArray editable(List<?> array) {
      if (array == null)
         return null;
      if (array instanceof EditableArray)
         return (EditableArray) array;
