...
public interface Validator extends Serializable {
    ...
    * 
    * @param fieldValue
    *           the field value to be validated; may be null
    * @param fieldName
    ...
    *           top-level document
    * @param problems
    *           the problems where any errors or warnings should be recorded; never null
    * @param resolver
    *           the component that can be used to resolve references to other schema documents
    */
   void validate(Object fieldValue, String fieldName, Document document, Path pathToDocument, Problems problems,
