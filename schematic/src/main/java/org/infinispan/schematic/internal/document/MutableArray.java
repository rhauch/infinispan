...
public interface MutableArray extends Array, MutableDocument {
   ...
   /**
    * Modifiable method that adds the supplied value if not already in the array. This method should <i>not</i> be
   ...
   /**
    * Modifiable method that adds the supplied value at the supplied index, shifting any existing values to the next
    * higher index value. This method should <i>not</i> be called by client code.
    * 
    * @param value
    *           the value to be added
    */
   ...
   /**
    * Modifiable method that sets the supplied value at the given index. This method should <i>not</i> be called by
    * client code.
    * 
    * @param index
    *           the index
   ...
   /**
    * Modifiable method that removes the value at the supplied index. This method should <i>not</i> be called by client
    * code.
    * 
    * @param value
    *           the value to be removed
   ...
   /**
    * Modifiable method that adds the supplied values at the end of this array. This method should <i>not</i> be called
    * by client code.
    * 
    * @param values
   ...
   /**
    * Modifiable method that adds the supplied values at the supplied index, shifting any existing values to the next
    * higher index value. This method should <i>not</i> be called by client code.
    * 
    * @param index
   ...
   /**
    * Modifiable method that removes all of the values from this array. This method should <i>not</i> be called by
    * client code.
    */
   void removeAll();

   /**
    * Modifiable method that removes all of the supplied values from this array. This method should <i>not</i> be called
    * by client code.
    * 
    * @param values
    *           the values to be removed
    * @return the entries that were removed; never null but possibly empty if this array was not modified by this
    *         operation
    */
   List<Entry> removeAllValues(Collection<?> values);

   /**
    * Modifiable method that removes all of the values in this array except the supplied values. This method should
    * <i>not</i> be called by client code.
    * 
    * @param values
