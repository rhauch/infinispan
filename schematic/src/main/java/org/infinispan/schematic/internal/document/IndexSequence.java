...
/**
 * An {@link IndexSequence} is a lightweight ordered sequence of string representing array indexes. It is lightweight
 * because it shares and reuses the strings for indexes less than the {@link #MAXIMUM_KEY_COUNT maximum key count}.
 * 
...
public class IndexSequence implements Set<String> {
   ...
   /**
    * Obtain an iterator for the indexes up the {@link Integer#MAX_VALUE largest} integer. This is efficient, because it
    * only builds strings as needed.
    * 
    * @param size
    *           the number of indexes
    * @return the iterator of string indexes; never null
