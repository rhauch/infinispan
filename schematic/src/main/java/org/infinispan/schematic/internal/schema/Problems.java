...
public interface Problems {
    ...
    * @param message
    *           the message describing the error; may not be null
    */
    ...
    *           the message describing the error; may not be null
    * @param exception
    *           the exception that occurred and that is considered the cause
    */
    ...
    *           the path; may not be null
    * @param message
    *           the message describing the warning; may not be null
    */
