 ...
 * <p>
 * The modified JSON format is nearly identical to the JSON serialization used by MongoDB. All standard JSON values are
 * written as expected, but the types unique to BSON are written as follows:
...
public interface JsonWriter {
    ...
    *           the BSON object or BSON value; may not be null
    * @param builder
    *           the string builder; may not be null
    */
