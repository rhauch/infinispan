...
/**
 * A cache of ByteBuffer, used in {@link LittleEndianDataInputStream}.
 * 
...
public class BufferCache {
   ...
   /**
    * The maximum number of bytes in each cached buffer. If a buffer is too large, then using it and caching it
    * in-memory will be too costly.
    */
