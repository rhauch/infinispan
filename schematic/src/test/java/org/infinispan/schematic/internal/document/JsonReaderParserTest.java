...
@Test(groups = "functional", testName = "bson.impl.JsonReaderParserTest")
public class JsonReaderParserTest {
   ...
   public void shouldParseValueGivenLongValues() throws Exception {
      assert new Long((long) Integer.MAX_VALUE + 1L).equals(parser("" + ((long) Integer.MAX_VALUE + 1L)).parseValue());
      assert new Long((long) Integer.MIN_VALUE - 1L).equals(parser("" + ((long) Integer.MIN_VALUE - 1L)).parseValue());
   ...
   public void shouldParseValueGivenDoubleValues() throws Exception {
      ...
      assert new Double((double) Float.MAX_VALUE + 1f)
               .equals(parser("" + ((double) Float.MAX_VALUE + 1f)).parseValue());
      assert new Double((double) Float.MIN_VALUE - 1f)
               .equals(parser("" + ((double) Float.MIN_VALUE - 1f)).parseValue());
