...
@Test(groups = "functional", testName = "bson.impl.CompactJsonWriterTest")
public class CompactJsonWriterTest {
   ...
   public void shouldCorrectlyWriteLongValues() {
      ...
      assertSame(Long.toString((long) Integer.MAX_VALUE + 10L), writer.write((long) Integer.MAX_VALUE + 10L));
      assertSame(Long.toString((long) Integer.MIN_VALUE - 10L), writer.write((long) Integer.MIN_VALUE - 10L));
